...
final class TelecineModule {
    ...
    @Singleton
    @HideFromRecents
    BooleanPreference provideHideFromRecentsPreference(
            SharedPreferences prefs) {
    ...
    @Singleton
    @ShowTouches
    BooleanPreference provideShowTouchesPreference(
            SharedPreferences prefs) {
    ...
    @Singleton
    @RecordAudio
    BooleanPreference provideRecordAudioPreference(SharedPreferences prefs) {
        return new BooleanPreference(prefs, "record_audio", DEFAULT_SHOW_TOUCHES);
    }

    @Provides
    @RecordAudio
    Boolean provideRecordAudio(@RecordAudio BooleanPreference pref){
        return pref.get();
    }
    ...
    @Singleton
    @VideoSizePercentage
    IntPreference provideVideoSizePercentagePreference(
            SharedPreferences prefs) {
